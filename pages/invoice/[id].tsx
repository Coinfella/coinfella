...
const DynamicOnramper = dynamic(() =>
    import('../../components/DynamicOnramper'), {ssr:false}
)
...
const Pay: NextPage = () => {
  ...
  }, [invoice, amount, preferredCrypto, walletAddress, router.isReady, router.query.id])
        ...
        <div className={styles.container}>
          <Grid className={styles.payContainer}>
            ...
            <Grid.Col sm={12} md={6}>
              ...
              <DynamicOnramper amount={amount} preferredCrypto={preferredCrypto} walletAddress={walletAddress}/>
