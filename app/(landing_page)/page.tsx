      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          ...
          <div className="grid gap-4 py-4">
            <Input type="text" onChange={(e)=>setWaitListUrl(e.target.value)} value={waitListUrl} />
          </div>
          <DialogFooter>
            <Button
              isLoading={loading}
